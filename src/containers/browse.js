    ...
    <>
      ...
      <Header src="joker1" dontShowOnSmallViewPort>
        <Header.Frame>
          ...
          <Header.Group>
              <Header.SearchTerm searchTerm={searchTerm} setSearchTerm={setSearchTerm}></Header.SearchTerm>
            <Header.Profile>
        ...
        <Header.Feature>
          ...
          <Header.Text>
            Forever alone in the crowd, failed comedian Arthur seeks connection
